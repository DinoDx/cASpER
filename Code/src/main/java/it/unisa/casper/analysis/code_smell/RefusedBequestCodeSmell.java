...
/**
 * Classe concreta che istanzia lo smell "Refused Bequest"
 */
public class RefusedBequestCodeSmell extends ClassLevelCodeSmell {
    /**
     * Costruttore
     *
     ...
     */
    public RefusedBequestCodeSmell(ClassSmellDetectionStrategy detectionStrategy, String algoritmsUsed) {
        super(REFUSED_BEQUEST, detectionStrategy, algoritmsUsed);
    }
