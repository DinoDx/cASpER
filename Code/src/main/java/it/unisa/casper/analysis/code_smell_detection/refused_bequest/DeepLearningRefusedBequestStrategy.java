...
public class DeepLearningRefusedBequestStrategy implements ClassSmellDetectionStrategy {

    private Vector<String> metrics = new Vector<String>();

    public DeepLearningRefusedBequestStrategy(Vector<String> metrics){
    ...
    public boolean isSmelly(ClassBean aClass) {
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                in.close();
                if(content.toString().equals("[0. 0. 0. 1. 0.]"))
                    return true;
            }
        } catch (IOException e) {
