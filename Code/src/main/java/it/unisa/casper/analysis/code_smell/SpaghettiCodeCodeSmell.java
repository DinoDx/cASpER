...
/**
 * Classe concreta che istanzia lo smell "Spaghetti Code"
 */
public class SpaghettiCodeCodeSmell extends ClassLevelCodeSmell{
    /**
     * Costruttore
     *
     ...
     */
    public SpaghettiCodeCodeSmell(ClassSmellDetectionStrategy detectionStrategy, String algoritmsUsed) {
