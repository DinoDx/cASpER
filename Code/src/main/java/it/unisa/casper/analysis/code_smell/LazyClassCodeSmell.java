...
/**
 * Classe concreta che istanzia lo smell "Lazy Class"
 */
public class LazyClassCodeSmell  extends ClassLevelCodeSmell {
    /**
     * Costruttore
     *
     ...
     */
    public LazyClassCodeSmell(ClassSmellDetectionStrategy detectionStrategy, String algoritmsUsed) {
        super(LAZY_CLASS, detectionStrategy, algoritmsUsed);
    }
