...
public class DeepLearningLazyClassStrategy implements ClassSmellDetectionStrategy {

    private Vector<String> metrics = new Vector<String>();
    private String risultato;

    public DeepLearningLazyClassStrategy(Vector<String> metrics){
    ...
    public boolean isSmelly(ClassBean aClass) {
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                in.close();
                if(content.toString().equals("[0. 0. 1. 0. 0.]")){
